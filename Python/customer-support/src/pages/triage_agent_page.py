...
st.caption(
    "Load **open** and **pending** tickets from Railengine, then run the Railtracks agent "
    "to prioritize the queue and explain why each ticket needs attention."
)
